...
namespace ProjetoBackend.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        public async Task<IActionResult> Search(string nome)
        {
            ...
            var categoria = await _context.Categorias.Where(c => c.Nome.Contains(nome)).ToListAsync();
            return View("Index", categoria.OrderBy(c => c.Nome)); // Reuse the existing Index view
        }
